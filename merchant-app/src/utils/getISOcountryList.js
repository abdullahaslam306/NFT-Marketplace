const countryListAllIsoData = [
  ...
  { code: "AN", code3: "ANT", name: "Netherlands Antilles", number: "0530" },
...
export const getIso2CodeCountryList = (countries) => {
  let ctry = countryListAllIsoData.filter((o1) =>
    countries.some((o2) => o1.code3 === o2.iso3)
  );
  return ctry.map((a) => a.code.toLowerCase());
};
