/**
 * Countries meta data along with helper functions
*/
...
const countries = [
  ...
  { iso3: 'HRV', name: 'Croatia (Hrvatska)' },
...
/**
 * Get complete list of allowed countries
 */
function getAll() {
  return countries;
}
...
function getByCode(code) {
  ...
  if (isValid(code) === true && code.length > 0) {
    ...
    result = countries.find(country => country.iso3 === searchTerm);
  }
  return result;
}
